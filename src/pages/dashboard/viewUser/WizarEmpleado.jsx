  ...
  return (
    <>
      <div className="col-12 col-md-6 px-1">
        <SectionCard objetos={datosEmpleo} tittle={"Datos del empleo"} icon={titleIcons["Datos del empleo"]}></SectionCard>
      </div>
      <div className="col-12 col-md-6 px-1">
        <SectionCard objetos={datosSalariales} tittle={"Datos Salariales"} icon={titleIcons["Datos Salariales"]}></SectionCard>
      </div>
      <div className="col-12 col-md-6 px-1">
        <SectionCard objetos={datosHorario} tittle={"Horario"} icon={titleIcons["Horario"]}></SectionCard>
      </div>
    </>
  );
  // return (
